...
capture log close
log using "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\log\C6_graphs", replace text
set more off
...
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f1.png", replace width(3000)

hist ftotval if ftotval< 60000 & ftotval>0, bin(100) percent normal
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f2.png", replace width(3000)
...
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f3.png", replace width(3000)



hist ftotval if ftotval< 60000 & ftotval>0, bin(100) percent title(Family Income Distribution) subtitle(2015) /// 
note(Source: CPS) 
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f3_ex.png", replace width(3000)
...
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f5.png", replace width(3000)

hist sex, discrete percent title(gender) subtitle(2015) xtitle(gender) ytitle(percent) xlabel(1 "male" 2 "female")
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f6.png", replace width(3000)

** kdensity

kdensity ftotval if ftotval< 60000 & ftotval>10000, bwidth(3)
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f7.png", replace width(3000)

kdensity ftotval if ftotval< 60000 & ftotval>10000, bwidth(3) normal
graph export "C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\pic\C6_f8.png", replace width(3000)
...
use C:\Users\mm_wi\Documents\ntu_agecon\laborecon\Class_Data\rawdata\pwt90.dta,replace
